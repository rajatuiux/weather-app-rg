...
let gradientColor = document.querySelector(".topContent");
function changeGradient(first, second) {
  gradientColor.style.background = `linear-gradient(180deg, ${first} 0%, ${second} 100%)`;
}
